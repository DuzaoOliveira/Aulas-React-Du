                ...
                <div className="form">
                  ...
                  >
                    ...
                    {qtdDomingoManha < qtdMAxima && (
                      <option value="manha"> {aguarp ? 'Sábado  15:30hs' : 'Terca 15:30hs'} </option>
                    )}
                    {qtdDomingoNoite < qtdMAxima && (
                      <option value="noite"> {aguarp ? 'Sábado - 18:30hs' : 'Terça 18:30hs'} </option>
                    )}
                  </select>
                  {/* <br></br>
                  ...
                  <div className="vagas">
                    ...
                    <span>
                      {aguarp ? <>Sábado 15hs</> : <>segunda 18hs-</>}
                      {qtdDomingoManha >= qtdMAxima && (
                        <small className="red"> vagas encerradas</small>
                      )}
                      {qtdDomingoManha < qtdMAxima && (
                  ...
                  <br></br>
                {butt === 'ativo' && <><button onClick={salve}>Inscreve</button></> } 
