...
function Query() {
  ...
  return (
    <div className="cards">
      ...
      {urlParams.mundial3 === 'tacas' && <img src="https://2.bp.blogspot.com/-vB-Rcg4iT4Y/V0TfrCHdJ3I/AAAAAAAAWOk/0aU9jzGD1-EOCtNAAUKZAnyGxLoqFfxIwCLcB/s1600/trofeu%2Bdo%2Bmundial%2Binterclubes%2B1992%2B1993%2B2005%2Bsao%2Bpaulo.JPG"alt="mundial do spfc"></img>}
      {urlParams.mundial1 === 'tacas' && <img src="https://i.pinimg.com/474x/dd/b1/3d/ddb13d94236e7956c5fc602bdf0e1e59--sports-clubs-sports-games.jpg"alt="mundial do sccp"></img>}
      {urlParams.mundial0 === 'tacas' && <img src="https://img1.gratispng.com/20180822/yss/kisspng-portable-network-graphics-computer-icons-error-ima-soylent-red-error-7-icon-free-soylent-red-error-5b7d3123af5f97.8912347015349312357183.jpg"alt="mundial do sep"></img>}
    </div>
  )
